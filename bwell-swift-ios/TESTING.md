...
```bash
echo -n "eyJyIjoiNWV4b3d2N2RqZzVtbWpyb2JlaiIsImVudiI6ImNsaWVudC1zYW5kYm94Iiwia2lkIjoic2Ftc3VuZy1jbGllbnQtc2FuZGJveCJ9" | xcrun simctl pbcopy "0C084754-DF2E-4CC9-960C-44EB0B7C1629"
```
...
MHcCAQEEIJQiJHQxjGRsZ/jT+dauHkjj3AfqaX+VM+I2+WkQgV9xoAoGCCqGSM49
AwEHoUQDQgAERiXp4+/NsDAiIO7Giwz3294QdqU/4BNWcCTRh8eQEJ5etKTNQl0N
G0VKC0qgi+QEIAfUocoQLQmtynz50nHcbQ==
-----END EC PRIVATE KEY-----\`;
console.log(jwt.sign({guid:'bwell-test-token_xxHi79qUfx5JGHWkGdet/g==',otid:false,
  exp:Math.floor(Date.now()/1000)+86400,iat:Math.floor(Date.now()/1000)},pk,
  {algorithm:'ES256',keyid:'bwell-test-token'}));
...
node -e "const jwt=require('/Users/billfield/dev/bwell-identity-gateway/node_modules/jsonwebtoken');const pk=\`-----BEGIN EC PRIVATE KEY-----\nMHcCAQEEIJQiJHQxjGRsZ/jT+dauHkjj3AfqaX+VM+I2+WkQgV9xoAoGCCqGSM49\nAwEHoUQDQgAERiXp4+/NsDAiIO7Giwz3294QdqU/4BNWcCTRh8eQEJ5etKTNQl0N\nG0VKC0qgi+QEIAfUocoQLQmtynz50nHcbQ==\n-----END EC PRIVATE KEY-----\`;console.log(jwt.sign({guid:'bwell-test-token_xxHi79qUfx5JGHWkGdet/g==',otid:false,exp:Math.floor(Date.now()/1000)+86400,iat:Math.floor(Date.now()/1000)},pk,{algorithm:'ES256',keyid:'bwell-test-token'}));" | xcrun simctl pbcopy "0C084754-DF2E-4CC9-960C-44EB0B7C1629"
```
